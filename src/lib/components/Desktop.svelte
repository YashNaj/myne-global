...
<PageContainer>
  <TabGroup class="w-full h-full">
    ...
    <TabPanels class="w-full h-[80vh]  mt-2">
      <div class="wrapper w-full h-full relative px-2 mt-2 rounded">
        <TabPanel
          class="w-full h-full flex flex-col px-2 rounded-2xl bg-gradient-to-b from-slate-300 to-slate-100"
        >
          <div class="navbar bg-none">
            ...
            <div class="navbar-center">
              <select
                class="select w-full max-w-xs bg-transparent text-center px-2 flex justify-center"
              >
