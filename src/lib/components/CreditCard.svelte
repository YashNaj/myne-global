    ...
    *:focus {
    ...
    <form name="helcimForm" id="helcimForm" action="your-checkout-page.php" method="POST" class ='card-form__inner'>
          ...
          <div class="card-input">
            ...
            <input type="text" id="cardNumber" class="input input-sm w-full" v-mask="generateCardNumberMask" bind:value={cardNumber} on:focus={focusInput} on:blur={blurInput} data-ref="cardNumber" autocomplete="off">
          </div>
          <div class="card-input">
          ...
          <div class="card-form__row">
            ...
            <div class="card-form__col cvv">
              <div class="card-input">
                ...
                <input type="text" class="input input-sm w-full" id="cardCvv" v-mask="'####'" maxlength="4" bind:value={cardCvv} on:focus={() => isCardFlipped = true} on:blur={() => isCardFlipped = false} autocomplete="off">
              </div>
            </div>
            <div class="card-form__col cvv">
                <div class="card-input">
