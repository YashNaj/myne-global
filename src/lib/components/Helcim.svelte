...
<div class="flex justify-center">
  <div class="card-orm">
          ...
          <div class="card-item__wrapper">
            ...
            <div class="card-item__content">
              ...
              >
                ...
                {#if cardName.length}
                  <div class="card-item__name">
                    {#each cardName.replace(/\s\s+/g, " ") as n, index (index + 1)}
                      {#if index == index}
                        <span in:fly={{ y: -6 }} class="card-item__nameItem"
                          >{n}</span
                        >
                      {/if}
                    {/each}
                ...
                {:else}
                  <div in:fly={{ y: -6 }} class="card-item__name placeholder">
                    Full Name
                  </div>
                {/if}
              </label>
              <div class="card-item__date" bind:this={refs.cardDate}>
                ...
                <label for="cardYear" class="card-item__dateItem">
                  ...
                  {#each [cardYear] as cardYear (cardYear)}
                    <span in:fly={{ y: -6 }} out:fly={{ y: 6 }}
                      >{cardYear ? String(cardYear).slice(2, 4) : "YY"}</span
                    >
                  {/each}
    ...
    <div class = 'card bg-base-100 p-10 shadow-lg'
    >
    <form
      name="helcimForm"
      id="helcimForm"
      ...
      method="POST"
      class = "pt-20 text-primary  justify-center align-center "
    >
      <!--RESULTS-->
      ...
      <!--CARD-INFORMATION-->
      Card Token: <input type='hidden' id="cardToken" value="1" /><br />
      Credit Card Number:
      <input
        type="text"
        id="cardNumber"
      ...
      <div class = 'flex justify-between flex-wrap'>
        <div class = 'flex flex-col flex-2 mr-2'>
            Expiry Month:
            <input class = 'input input-sm' type="text" id="cardExpiryMonth" bind:value={cardMonth} />
    
        </div>
        <div class = 'flex flex-col flex-2 mr-2'>
            Expiry Year:
            <input class = 'input input-sm w-full'type="text" id="cardExpiryYear" bind:value={cardYear} /><br />
        </div>
      ...
      <div class = 'flex flex-col'>
        ...
        <input type="text" class ='input input-sm' id="cardHolderPostalCode" value="" /><br />
  
  
      </div>
      <!--OPTIONAL-AMOUNT-->
      <div class = 'flex justify-between content-center wrap'>
        <div class = 'flex-col'>
            Amount: <input type="text" class= 'input input-ghost input-sm flex' id="amount" value="100.00" /><br />
        </div>
      ...
      <input type="button" class ='btn btn-primary w-full ' id="buttonProcess" value="Process" />
