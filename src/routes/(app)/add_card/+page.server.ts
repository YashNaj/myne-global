...
export const actions: Actions = {
  default: async ({ request, locals }) => {
    ...
    const crypto_token_address = form.get('crypto_token_address')?.toLowerCase();
    ...
    const distinguishing_features = form.get('distinguishing_features')?.toLowerCase();
    ...
    const registration_certificate = form.get('registration_certificate')?.toLowerCase();
    ...
    const smart_contract_address = form.get('smart_contract_address')?.toLowerCase();
