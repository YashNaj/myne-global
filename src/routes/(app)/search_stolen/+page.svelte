...
<div class="w-full h-full flex flex-col justify-around p-3">
  <h1 class="flex w-full justify-center text-white text-3xl font-bold">Find a Stolen Watch</h1>

  <form class="card w-full h-64 text-black" method="POST" use:enhance>
    <input id="category" placeholder="Category" name="category" class="input input-md text-primary mt-2" />
    <input id="brand" placeholder="Brand" name="brand" class="input input-md text-primary mt-2" />

    <input id="serialNumber" placeholder="Serial" name="serialNumber" class="input input-md text-primary mt-2" />
